...
type Profile struct {
	...
	PhoneNumber string        `json:"phone_number" doc:"Phone number (E.164)"  example:"+358401234567"`
	Marketing   bool          `json:"marketing"    doc:"Marketing opt-in"      example:"true"`
	Terms       bool          `json:"terms"        doc:"Terms acceptance"      example:"true"`
	CreatedAt   timeutil.Time `json:"created_at"   doc:"Creation timestamp"    example:"2024-01-15T10:30:00.000Z"`
	UpdatedAt   timeutil.Time `json:"updated_at"   doc:"Last update timestamp" example:"2024-01-15T10:30:00.000Z"`
}
